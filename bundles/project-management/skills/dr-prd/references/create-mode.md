...
> Note: Created `_project/prd/` on the fly. Run `/dr-init` if you'd like the full project scaffolding (`_project/plans/`, `_project/research/`, etc.) plus a versioned AGENTS.md.
